...
class y extends e {
    ...
    renderSingleCanvas(t, e, i, n, s, r, o) {
        ...
        if (e.renderFunction ? (h.fillStyle = this.convertColorValues(e.waveColor), e.renderFunction(t, h)) : this.renderWaveform(t, e, h), l.width > 0 && l.height > 0) {
...
function r(t, e = {}) {
    const { threshold: i = 3, mouseButton: n = 0, touchDelay: s = 100 } = e, r1 = function(t) {
        let e = t;
        const i = new Set;
        return {
            get value () {
    ...
    }(null), o = new Map, a = matchMedia("(pointer: coarse)").matches;
    let l = ()=>{};
    const h = (e)=>{
        if (e.button !== n) return;
        if (o.set(e.pointerId, e), o.size > 1) return;
        let h = e.clientX, d = e.clientY, c = !1;
        const u = Date.now(), v = t.getBoundingClientRect(), { left: p, top: g } = v, m = (t)=>{
            if (t.defaultPrevented || o.size > 1) return;
            if (a && Date.now() - u < s) return;
            const e = t.clientX, n = t.clientY, l = e - h, v = n - d;
            (c || Math.abs(l) > i || Math.abs(v) > i) && (t.preventDefault(), t.stopPropagation(), c || (r1.set({
                type: "start",
                x: h - p,
                y: d - g
            }), c = !0), r1.set({
    ...
    return {
        signal: r1,
        cleanup: ()=>{
            l(), t.removeEventListener("pointerdown", h), o.clear(), function(t) {
                const e = t._cleanup;
                "function" == typeof e && e();
            }(r1);
        }
...
class o extends t {
    ...
    initMouseEvents() {
        ...
        if (!t) return;
        t.addEventListener("click", (t)=>this.emit("click", t)), t.addEventListener("mouseenter", (t)=>this.emit("over", t)), t.addEventListener("mouseleave", (t)=>this.emit("leave", t)), t.addEventListener("dblclick", (t)=>this.emit("dblclick", t)), t.addEventListener("pointerdown", ()=>this.toggleCursor(!0)), t.addEventListener("pointerup", ()=>this.toggleCursor(!1));
        const e = r(t), i = s(()=>{
            const t = e.signal.value;
    ...
    _onUpdate(t, e, i) {
        ...
        let o = e && "start" !== e ? this.start : this.start + r, a = e && "end" !== e ? this.end : this.end + r;
        const l = void 0 !== i;
        l && this.updatingSide && this.updatingSide !== e && ("start" === this.updatingSide ? o = i : a = i), o = Math.max(0, o), a = Math.min(this.totalDuration, a);
        const h = a - o;
        this.updatingSide = e;
        const d = h >= this.minLength && h <= this.maxLength;
        o <= a && (d || l) && (this.start = o, this.end = a, this.renderPosition(), this.emit("update", e));
    }
    onMove(t) {
...
class a extends e {
    ...
    adjustScroll(t) {
        ...
        if (r <= s) return;
        const o = n.getBoundingClientRect(), a = t.element.getBoundingClientRect(), l = a.left - o.left, h = a.right - o.left;
        l < 0 ? n.scrollLeft += l : h > s && (n.scrollLeft += h - s);
    }
    virtualAppend(t, e, i) {
        const n = ()=>{
            if (!this.wavesurfer) return;
            const n = this.wavesurfer.getWidth(), s = this.wavesurfer.getScroll(), r = e.clientWidth, o = this.wavesurfer.getDuration(), a = Math.round(t.start / o * r), l = a + (Math.round((t.end - t.start) / o * r) || 1) > s && a < s + n;
            l && !i.parentElement ? e.appendChild(i) : !l && i.parentElement && i.remove();
        };
        setTimeout(()=>{
    ...
    enableDragSelection(t, e = 3) {
        ...
        const d = r(n, {
            ...
            if (n) if ("start" === n.type) {
                if (l = n.x, !this.wavesurfer) return;
                const s = this.wavesurfer.getDuration(), r = null === (i = null === (e = this.wavesurfer) || void 0 === e ? void 0 : e.getDecodedData()) || void 0 === i ? void 0 : i.numberOfChannels, { width: d } = this.wavesurfer.getWrapper().getBoundingClientRect();
                h = l / d * s;
                const c = n.x / d * s, u = (n.x + 5) / d * s;
                a = new o(Object.assign(Object.assign({}, t), {
                    start: c,
                    end: u
                }), s, r), this.emit("region-initialized", a), a.element && this.regionsContainer.appendChild(a.element);
            } else "move" === n.type && void 0 !== n.deltaX ? a && a._onUpdate(n.deltaX, n.x > l ? "end" : "start", h) : "end" === n.type && a && (this.saveRegion(a), a.updatingSide = void 0, a = null);
        }, [
            d.signal
        ]);
        return ()=>{
...
"[project]/node_modules/lucide-react/dist/esm/icons/file-search-corner.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const FileSearchCorner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("file-search-corner", __iconNode);
;
 //# sourceMappingURL=file-search-corner.js.map
}),
"[project]/node_modules/lucide-react/dist/esm/icons/file-search-corner.js [app-client] (ecmascript) <export default as FileSearchCorner>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/scissors-line-dashed.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ScissorsLineDashed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("scissors-line-dashed", __iconNode);
;
 //# sourceMappingURL=scissors-line-dashed.js.map
}),
"[project]/node_modules/lucide-react/dist/esm/icons/scissors-line-dashed.js [app-client] (ecmascript) <export default as ScissorsLineDashed>", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    "PropagateLoader",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$spinners$2f$esm$2f$PropagateLoader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
...
//# sourceMappingURL=node_modules_481b4b7e._.js.map