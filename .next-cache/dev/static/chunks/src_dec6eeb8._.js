...
const Editor = ()=>{
    ...
    const editorMessageKindRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])("default");
    ...
    const [editorMessage, setEditorMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [editorMessageKind, setEditorMessageKind] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("default");
    ...
    const focusMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Editor.useCallback[focusMessage]": ()=>{
            ...
            }["Editor.useCallback[focusMessage]"], 1800);
        }
    }["Editor.useCallback[focusMessage]"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Editor.useEffect": ()=>{
            const loadFFmpeg = {
                "Editor.useEffect.loadFFmpeg": async ()=>{
                    if (!ffmpegRef.current) {
                        try {
                            ...
                            ffmpeg.on("log", {
                                "Editor.useEffect.loadFFmpeg": ({ message })=>{
                                    console.log("[FFmpeg]", message);
                                }
                            }["Editor.useEffect.loadFFmpeg"]);
                            ffmpeg.on("progress", {
                                "Editor.useEffect.loadFFmpeg": ({ progress })=>{
                                    setFFmpegProgress({
                                        "Editor.useEffect.loadFFmpeg": (current)=>Math.max(current, progress)
                                    }["Editor.useEffect.loadFFmpeg"]);
                                }
                            }["Editor.useEffect.loadFFmpeg"]);
                            await ffmpeg.load();
        ...
        "Editor.useEffect": ()=>{
            ...
            const timer = window.setInterval({
                "Editor.useEffect.timer": ()=>{
                    setFFmpegProgress({
                        "Editor.useEffect.timer": (current)=>{
                            if (current >= 0.92) {
                                return current;
                            }
        ...
        "Editor.useEffect": ()=>{
            if (waveformRef.current && !wavesurferRef.current) {
                ...
                wavesurferRef.current.on("decode", {
                    "Editor.useEffect": (decodedDuration)=>{
                        setDuration(decodedDuration);
                        setWaveformLoading(false);
                        setEditorMessage({
                            "Editor.useEffect": (current)=>editorMessageKindRef.current === "ffmpeg-loading" ? current : null
                        }["Editor.useEffect"]);
                        wsRegions.getRegions().forEach({
                            "Editor.useEffect": (region)=>region.remove()
                        }["Editor.useEffect"]);
                        wsRegions.addRegion({
                            start: 0,
                ...
                wavesurferRef.current.on("play", {
                    "Editor.useEffect": ()=>setIsPlaying(true)
                }["Editor.useEffect"]);
                wavesurferRef.current.on("pause", {
                    "Editor.useEffect": ()=>setIsPlaying(false)
                }["Editor.useEffect"]);
                wavesurferRef.current.on("error", {
                    "Editor.useEffect": (error)=>{
        ...
        "Editor.useEffect": ()=>{
            try {
                if (proxiedAudioUrl) {
                    if (wavesurferRef.current) {
                        setEditorMessage({
                            "Editor.useEffect": (current)=>editorMessageKind === "ffmpeg-loading" ? current : null
                        }["Editor.useEffect"]);
    ...
    const handleExport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Editor.useCallback[handleExport]": async (format)=>{
            ...
            try {
                ...
                anchor.click();
                setTimeout({
                    "Editor.useCallback[handleExport]": ()=>{
                        window.URL.revokeObjectURL(url);
                        document.body.removeChild(anchor);
                    }
                }["Editor.useCallback[handleExport]"], 100);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                editorMessage ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ref: messageRef,
                    tabIndex: -1,
                    role: "alert",
                    "aria-live": "polite",
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "relative",
                        children: [
                            editorMessageKind === "ffmpeg-loading" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                "aria-hidden": "true",
...
_s(Editor, "ABaWAwTTByvJMVWLz7fL6Z4YgE4=", false, function() {
    return [
...
//# sourceMappingURL=src_dec6eeb8._.js.map